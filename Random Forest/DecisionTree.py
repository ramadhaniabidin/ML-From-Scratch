...
class DecisionTree:
    ...
    def _grow_tree(self, X, y, depth=0):
        ...
        # create child nodes
        left_idxs, rigth_idxs = self._split(X[:, best_feature], best_thresh)
        left = self._grow_tree(X[left_idxs, :], y[left_idxs], depth+1)
        right = self._grow_tree(X[rigth_idxs, :], y[rigth_idxs], depth+1)
    ...
    def _split(self, X_column, split_threshold):
        ...
        rigth_idxs = np.argwhere(X_column > split_threshold).flatten()
